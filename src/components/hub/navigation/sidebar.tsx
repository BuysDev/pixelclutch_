import { ArrowLeftRight, PlaySquareIcon, PlusCircleIcon, SearchIcon, MessageSquare } from "lucide-react";
    ...
    return (
        <aside className={`${open ? 'w-64' : 'hidden'} fixed h-screen z-2 border-r bg-cyber-black border-gray-800 text-white p-4`}>
            <nav className="space-y-2">
                ...
                <Link href="/hub/chat" className="block px-4 py-2 hover:bg-gray-700 rounded items-center">
