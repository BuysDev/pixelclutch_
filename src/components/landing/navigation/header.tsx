...
export default function Header() {
    ...
    return (
        <header className="h-20 flex sticky z-1 top-0 items-center justify-between px-4 border-b border-gray-800 bg-cyber-black">
            ...
            <div>
                <Button variant="outline" className="text-electric-pink cursor-pointer hover:text-white hover:bg-electric-pink/70 hover:border-electric-pink/70 font-bold" onClick={() => push('/auth/signin')}>
                    Sign In
                </Button>
            </div>
        </header>
